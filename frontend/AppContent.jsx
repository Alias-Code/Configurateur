...
export default function AppContent() {
  ...
  return (
    <HelmetProvider>
      <BrowserRouter>
        {/* <DragOverlay>{activeId && <img src={`/${activeId}`} style={{ width: "auto", height: "auto" }} />}</DragOverlay> */}

        {/* DYNAMIC FAVICON */}

        <Helmet>
          <link rel="icon" href={isDarkMode ? "/lumicrea_icon_white.webp" : "/lumicrea_icon_black.webp"} />
        </Helmet>
