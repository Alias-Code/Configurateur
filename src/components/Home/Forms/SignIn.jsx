...
export default function SignIn({ isSignInOpen, setSignInOpen, setSignUpOpen, modalAnimation, setModalAnimation }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`https://configurateur-git-main-alias-codes-projects.vercel.app/api/auth/login`, {
        method: "POST",
        headers: {
